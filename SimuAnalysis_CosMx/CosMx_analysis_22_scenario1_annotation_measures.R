...
annotation_wd <- paste0(ana_wd, "annotation_results_scenario1/")

seu_name_scenario1 <- paste0(ana_wd, "seu_fov", fov, "_scenario1.rda")
load(seu_name_scenario1)
...
res_acc_pou <- lapply(fovs, function(rfov, true_y, cts_refList, ref_i, annotation_wd) {
    ...
    methods <- 
        c("CAESAR", "Seurat", "scmap", "SingleR", "scPred", "CelliDt", "CelliD")
...
res_anno_measures_scenario1 <- list(
    acc_pou = res_acc_pou,
...
save(res_anno_measures_scenario1, file = paste0(ana_wd, "res_anno_measures_fov", fov, "_scenario1.rda"))
...
save(res_measures_scenario1, file = paste0(ana_wd, "res_measures_fov", fov, "_scenario1.rda"))
...
save(res_anno_measures_scenario1, file = paste0(ana_wd, "res_anno_measures_control_pou_0.05_fov", fov, "_scenario1.rda"))
