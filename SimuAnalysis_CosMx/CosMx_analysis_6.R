...
################################################################################
for (rfov in fovs) {
    load(paste0(ref_process_wd, "sig_list_scRNA_fov", rfov, ".rda"))
...
save(measures, iCAESAR_measures, file = paste0(ana_wd, "measures_fov", fov, "_bin5.rda"))
...
save(res_asw, file = paste0(ana_wd, "embedding_measures_fov", fov, "_bin5.rda"))


load(paste0("/share/analysisdata/zhangx/CosMx_CoFAST/processed_data_CosMx", i, "/degsbin5.rda"))
result <- degs %>%
...
save(res_coembed_score, file = paste0(ana_wd, "coembedding_measures_fov", fov, "_bin5.rda"))
