...
save(measures, iCAESAR_measures, file = paste0(ana_wd, "measures_fov", fov, ".rda"))
...
save(res_asw, file = paste0(ana_wd, "embedding_measures_fov", fov, ".rda"))


load(paste0("/share/analysisdata/zhangx/CosMx_CoFAST/processed_data_CosMx", i, "/degs.rda"))
result <- degs %>%
...
save(res_coembed_score, file = paste0(ana_wd, "coembedding_measures_fov", fov, ".rda"))
