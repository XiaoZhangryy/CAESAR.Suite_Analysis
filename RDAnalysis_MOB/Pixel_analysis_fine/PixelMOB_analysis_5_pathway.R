...
ct_enrich_pval <- CAESAR.CTDEP(y, pathway_scores, cts)
...
# if pathway with p value equal to zero larger than 5, manually select 5
...
save(pathway_usedList, file = paste0(enrich_wd, "pathway_usedList.rda"))


# ==============================================================================
# 3. plot pathways - fig. 4.e and 4.f
# ==============================================================================
## 3.1 data for plot
...
ggsave(
    file = paste0(enrich_wd, "dotplot_cts_pathway_matrix_CAESARua_pval.png"),
